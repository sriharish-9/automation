...
class FeedbackHandler:
    ...
    async def navigate_to_assignments(self):
        ...
        try:
            ...
            print(f"❌ Failed to navigate to assignments: {str(e)}")
            raise
    ...
    async def filter_done_assignments(self):
        ...
        try:
            ...
            print(f"❌ Failed to filter done assignments: {str(e)}")
            raise
    ...
    async def find_assignment_with_feedback(self, max_attempts=10):
        ...
        try:
            ...
            print(f"❌ Failed to find assignment with feedback: {str(e)}")
            raise
    ...
    async def give_feedback(self):
        ...
        try:
            ...
            print(f"❌ Failed to give feedback: {str(e)}")
            raise